...
# data "aws_ecr_image" "power-outage-pipeline-image" {
#   repository_name = "c16-energy-power-outage-pipeline"
#   image_tag = "latest"
# }
...
resource "aws_cloudwatch_log_group" "ecs_log_group" {
  name = "/ecs/c16-energy-power-outage-pipeline"
}
  ...
  container_definitions = jsonencode([
    {
        ...
        # image = "${data.aws_ecr_image.power-outage-pipeline-image.image_uri}"
...
resource "aws_security_group" "energy-outage-pipeline-sg" {
    name = "c16-energy-power-outage-pipeline-sg"
...
resource "aws_ecs_service" "c16-energy-power-outage-live-pipeline" {
  name = "c16-energy-power-outage-live-pipeline"
