...
@patch("send_alerts.find_provider_from_region_id")
...
@patch("send_alerts.get_region_from_postcode", return_value="fakeregion")
@patch("send_alerts.find_provider_from_region", return_value=321)
...
@patch("send_alerts.boto3.client")
@patch("send_alerts.alert_message_format", return_value="Test Alert")
